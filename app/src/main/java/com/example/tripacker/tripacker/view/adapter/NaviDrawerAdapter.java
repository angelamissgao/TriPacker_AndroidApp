 ...
 */
public class NaviDrawerAdapter extends RecyclerView.Adapter<NaviDrawerAdapter.ViewHolder> {
    ...
    public NaviDrawerAdapter(String Titles[], int Icons[], String Name, String Username, int Profile){ // MyAdapter Constructor with titles and icons parameter
    ...
    @Override
    public NaviDrawerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(NaviDrawerAdapter.ViewHolder holder, int position) {
